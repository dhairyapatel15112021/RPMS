        ...
        <div className='h-[90vh] w-[100vw] flex justify-center items-center'>
            <div className='shadow-md rounded-sm p-5 w-[30vw]'>
                ...
                <div className='flex flex-col mt-3 gap-2'>
                    {data?.user?.isAdmin && <Link to="/" className='flex justify-between items-center border border-blue-200 rounded-md shadow-2xs p-2'>
                        <div>Admin</div>
                        <div><Chevron /></div>
                    </Link>
                    }
                    ...
                    {data?.user?.isCandidate && <Link to="/" className='flex justify-between items-center border border-blue-200 rounded-md shadow-2xs p-2'>
                        <div>Candidate</div>
                        <div><Chevron /></div>
                    </Link>}
                </div>
