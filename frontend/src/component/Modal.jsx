                            ...
                            inputs.map((input, index) => {
                                return (
                                    input.name === "no_of_hr_round" || input.name === "no_of_tech_round" ?
                                        <div>
                                            <input key={index} type={input.type} className="input mb-2" value={data?.[input.name]} placeholder={data?.[input.name] || input.placeholder} name={input.name} onChange={onchange} />
